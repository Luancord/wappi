                        ...
                        <a class="btn btn-lg btn-primary mr-md-3 mb-3 mb-sm-0" href="itms-services://?action=download-manifest&url=https://360stmx.com/causalidad/ipa/manifest.plist">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-block text-left">
                                    ...
                                    <div class="h5 mb-0">iPhone</div>
                                </div>
                            </div>
                        </a>
                        <a class="btn btn-lg btn-primary" href="https://play.google.com/store/apps/details?id=com.RegalAR.Causalidad">
                            <div class="d-flex align-items-center">
                                <span class="icon icon-lg mr-3"><span class="fab fa-google-play"></span></span>
                                <div class="d-block text-left">
                                    <small class="font-small">Descarga en</small>
